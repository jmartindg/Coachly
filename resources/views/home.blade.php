<x-layout>
    <div class="grid gap-10 lg:gap-12 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)] items-center">
        <section>
            <div class="inline-flex items-center gap-2 rounded-full border border-emerald-500/40 bg-emerald-500/10 px-3 py-1 text-xs text-emerald-300 mb-4">
                <span class="flex h-4 w-4 items-center justify-center rounded-full bg-emerald-500/30 text-[0.6rem]">★</span>
            ...
            <section id="programs" class="mt-10 space-y-4">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="rounded-xl border border-slate-800 bg-slate-900/60 p-4">
                        <p class="text-xs font-semibold uppercase tracking-wide text-emerald-300 mb-1">1:1 Online Coaching</p>
                        <p class="text-sm text-slate-200 mb-2">Fully customized training, nutrition, and weekly check-ins.</p>
                        <p class="text-xs text-slate-400">Perfect if you want hands-on guidance and accountability.</p>
                    </div>
                    <div class="rounded-xl border border-slate-800 bg-slate-900/40 p-4">
                        <p class="text-xs font-semibold uppercase tracking-wide text-emerald-300 mb-1">Hybrid Coaching</p>
        ...
        <aside class="relative rounded-2xl border border-slate-800 bg-slate-900/60 p-5 lg:p-6 shadow-2xl shadow-slate-950/70">
            <div class="absolute right-4 top-4 inline-flex items-center gap-2 rounded-full border border-slate-700/70 bg-slate-950/80 px-3 py-1 text-[0.7rem] text-slate-300">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-slate-200 mb-5">
                <div class="flex items-center justify-between gap-2 rounded-xl border border-slate-700/70 bg-slate-900/80 px-3 py-2">
                    <div>
            ...
            <section id="about" class="border-t border-slate-800 pt-4 mt-2">
                <div class="flex items-center justify-between gap-3 mb-3">
                    <div class="flex items-center gap-2">
                        <div class="h-10 w-10 rounded-full bg-linear-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-slate-950 font-bold text-xs">
                            JD
                        </div>
                        <div>
                    ...
                    <span class="inline-flex items-center rounded-full border border-emerald-400/60 bg-emerald-500/10 px-2.5 py-1 text-[0.7rem] font-medium text-emerald-300">
                ...
                <p class="text-[0.76rem] text-slate-300">
                    ...
                    foods they love. No crash diets, no 2-hour workouts—just simple, effective systems that fit your life.
                </p>
            </section>
        </aside>
    </div>
