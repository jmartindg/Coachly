        ...
        <div class="w-full max-w-md space-y-8">
            <div class="flex items-center justify-center gap-2">
                ...
                <div class="text-center sm:text-left">
                    ...
                    <p class="text-xs text-slate-400">Client login</p>
                </div>
            </div>

            <div class="rounded-2xl border border-slate-800 bg-slate-900/70 px-5 py-6 sm:px-6 sm:py-7 shadow-2xl shadow-slate-950/60">
                {{ $slot }}
            </div>

            <p class="text-[0.7rem] text-center text-slate-500">
                Not a client yet?
                <a href="/" class="text-emerald-300 hover:text-emerald-200 transition-colors">Learn more about coaching</a>
            </p>
        </div>
    </div>
</body>
