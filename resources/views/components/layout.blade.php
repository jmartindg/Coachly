...
<body class="min-h-screen bg-slate-950 text-slate-50 flex flex-col">
    ...
    <footer id="contact" class="border-t border-slate-800/80 bg-slate-950/80">
        <div
            class="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-[0.7rem] sm:text-xs text-slate-500">
